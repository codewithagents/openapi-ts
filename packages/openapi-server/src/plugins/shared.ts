 ...
 * one { scheme, scopes } entry per key. Shared by the Fastify route emitter
 * (config.security metadata) and the Fastify service emitter (@security JSDoc).
 */
