...
| OpenAPI 3.0.x                   | Supported in practice. 8 of the 13 showcase specs are 3.0.x and all compile under `tsc --strict`. A few 3.0-only constructs such as `nullable: true` pass through; full 3.0 normalization is a planned feature. |
